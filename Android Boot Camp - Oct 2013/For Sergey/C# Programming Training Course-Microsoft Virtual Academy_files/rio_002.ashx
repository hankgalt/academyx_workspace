...
RioTrackingManager2.prototype.click=function(endActionCode,atlasTagCode){if(atlasTagCode!=null){this.fireAtlasClickTag(atlasTagCode,endActionCode);}
this.fireCrsClickTag(endActionCode);var date=new Date();var curDate=null
do{curDate=new Date();}
while(curDate-date<500);return true;}
RioTrackingManager2.prototype.clickChatDirect=function(endActionCode,atlasTagCode){this.isChat=true;this.click(endActionCode,atlasTagCode);return true;}
RioTrackingManager2.prototype.clickChatProactive=function(endActionCode,atlasTagCode){this.isChat=true;this.isProactiveChat=true;this.click(endActionCode,atlasTagCode);return true;}
...
RioTrackingManager2.prototype.fireCrsClickTag=function(endActionCode){document.cookie=this.endActionCodeCookieKey+"="+endActionCode.toString();var crsUrl=this.baseCrsClickUrl;crsUrl+="?CR_EAC="+endActionCode.toString();if(this.testMode){crsUrl+="&test=1";}
